        ...
        <div className="OutBooth slide-in">
            <div>
                ...
                <div className="neighborElement Element">
                    <div className="box  rounded-2xl p-5 pl-12">
                        <ul class="list-none">
                            <li className="font-semibold text-gray-700 mb-1">
                                <Link to="https://www.ktng.com/univ" className="flex items-center">
                                    1.<span className="mr-1  underline underline-offset-4 italic">해당링크로 참여신청</span><SlActionRedo /></Link></li>
                            <li className="NeighborsmallTag mb-4">#공책 #마스킹테이프 #스티커 #선정리클립</li>
                            <li className="font-semibold text-gray-700  mb-1">2. 주사위던지기 이벤트 진행</li>
            ...
            <div className='relative'>
                ...
                <div className="neighborElement Element">
                    <div className="box  rounded-2xl p-5 pl-12">
                        <ul class="list-none">
                            <li className="font-semibold text-gray-700 mb-1">1. 룰렛이벤트 진행</li>
                            <li className="NeighborsmallTag mb-4">다양한 <span className="font-bold">생리대 세트</span> 증정</li>
                            <li className="font-semibold text-gray-700  mb-1">2. 부스 방문시 <span className="italic neighborfontcolor">잇츠미 생리대</span> 증정</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div className="relative last">
                ...
                <div className="neighborElement Element">
                    <div className="box  rounded-2xl p-5 pl-12">
                        <ul class="list-none">
                            <li className="font-semibold text-gray-700 mb-1">
                                <span className="neighborfontcolor">레진 아트</span> (키링, 스트랩 등)<br />
                                10 ~ 20% 할인된 가격에 판매
                            </li>
                        </ul>
                    </div>
